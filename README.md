...
GenqaBot is a simple chatbot application built using Streamlit and Google GenAI model Gemini Pro. It allows users to ask questions and receive responses generated by the large language models.
